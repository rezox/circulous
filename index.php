...
<div style="margin: -70px auto 0 auto; width: 750px;">
   <div class="infobox" style="position: absolute;">
      <img src="resources/img/mailsr.png" valign="top" style="margin-right: 15px;" /><strong>A simple way to find the books you need.</strong><br />
   ...
   <div class="infobox" style="position: absolute; margin-top: 135px;">
      <img src="resources/img/check.png" valign="top" style="margin-right: 15px" /><strong>Safer.</strong><br />
   ...
   <div class="infobox" style="position: absolute; margin-left: 400px;">
      <img src="resources/img/moneyp.png" valign="top" style="margin-right: 15px;" /><strong>How does it all work?</strong><br />
   ...
   <div class="infobox" style="position: absolute; margin: 100px 0 0 400px;">
      <img src="resources/img/moneyc.png" valign="top" style="margin-right: 15px;" /><strong>Buying is just as easy.</strong><br />
